...
export function EventMessages() {
  ...
  return <section className="messages-section" aria-labelledby="messages-title"><div className="wrap"><div className="section-heading"><span className="eyebrow">Palabras que atesoraré</span><h2 id="messages-title">Mensajes para mí</h2></div><div ref={element} className="messages-carousel" onMouseMove={e => { const rect = element.current?.getBoundingClientRect(); if (rect) { mouseX.set(e.clientX - rect.left - rect.width / 2); mouseY.set(e.clientY - rect.top - rect.height / 2); } }}>
